...
<div className="rhub-endpoint">
  <div className="rhub-endpoint__row">
    <span className="rhub-method rhub-method--get">GET</span>
    <code className="rhub-endpoint__url">{'/ewallet/api/v1/customerOccupationType/getByCustomerTypeCode/{customerTypeCode}'}</code>
  </div>
  <div className="rhub-endpoint__envs">
    <span className="rhub-endpoint__env"><span className="rhub-endpoint__envname">Sandbox</span><code>https://sandbox-client.remittanceshub.com:8130/ewallet/api/v1/customerOccupationType/getByCustomerTypeCode/{customerTypeCode}</code></span>
    <span className="rhub-endpoint__env"><span className="rhub-endpoint__envname">Production</span><code>https://prod-api.remittanceshub.com:9091/ewallet/api/v1/customerOccupationType/getByCustomerTypeCode/{customerTypeCode}</code></span>
  </div>
</div>
...
GET - https://sandbox-client.remittanceshub.com:8130/ewallet/api/v1/customerOccupationType/getByCustomerTypeCode/100001
```
