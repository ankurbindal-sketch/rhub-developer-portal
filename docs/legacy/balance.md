...
<div className="rhub-endpoint">
  <div className="rhub-endpoint__row">
    <span className="rhub-method rhub-method--get">GET</span>
    <code className="rhub-endpoint__url">{'/api/v1/balance/{parameter}'}</code>
  </div>
  <div className="rhub-endpoint__envs">
    <span className="rhub-endpoint__env"><span className="rhub-endpoint__envname">Sandbox</span><code>https://sandbox-client.remittanceshub.com:8130/api/v1/balance/{parameter}</code></span>
    <span className="rhub-endpoint__env"><span className="rhub-endpoint__envname">Production</span><code>https://prod-api.remittanceshub.com:9091/api/v1/balance/{parameter}</code></span>
  </div>
</div>
...
GET - https://sandbox-client.remittanceshub.com:8130/api/v1/balance/all
```
...
HOST: sandbox-client.remittanceshub.com:8130
Content-Type: application/json; charset=utf-8
GET https://sandbox-client.remittanceshub.com:8130/api/v1/balance/USD
```
