...
*Source of truth: `customerRegistration.md` — from the RHUB documentation export of 2026-08-12 (`https://docs.remittanceshub.com/`).*

:::warning[Publication status — REVIEW REQUIRED]

This page is reproduced from the source file `customerRegistration.md`, which **is present in the RHUB
...
| email | String | M |  |
| mobileNo | String | M |  |
| gender | String | C | Required for individual only |
| nationality | String | C | As aforesaid |
| dateOfBirth | String | C | As aforesaid |
| tradeName | String | C | Required for business only |
| legalStatusCode | String | C | As aforesaid |
| natureOfBusinessCode | String | C | As aforesaid |
| businessRelationshipCode | String | M |  |
| occupationCode | String | C | Required for individual only |
| jobTitle | String | C | As aforesaid |
| jobIndustry | String | C | As aforesaid |
| employerName | String | C | As aforesaid |
...
| **Owner Details** |  |  |  |
| firstName | String | C | Required for business only |
| middleName | String | C | As aforesaid |
| lastName | String | C | As aforesaid |
| companyName | String | C | As aforesaid |
| gender | String | C | As aforesaid |
| nationality | String | C | As aforesaid |
| dateOfBirth | String | C | As aforesaid |
| email | String | C | As aforesaid |
| mobileNo | String | C | As aforesaid |
| addressline1 | String | C | As aforesaid |
| addressline2 | String | C | As aforesaid |
| city | String | C | As aforesaid |
| state | String | C | As aforesaid |
| pincode | String | C | As aforesaid |
| country | String | C | As aforesaid |
| residenceStatusCode | String | C | As aforesaid |
